...
echo "\n";
echo "\n";
echo "| Wilujeng sumping di ALFAGIFTxVIRGO ACCOUNT GENERATOR!! \n";
echo "|  by TH \n";
echo "| Wa 082319093269 \n";
echo "| SAMPURASUN \n";
if(file_exists("config.json")){
    ...
    $memberid = $arr2['id'];
    $hp = $arr2['hp'];
    echo "| Maneh geus login make nomor hp $hp \n";
    echo "| 1. Asup \n";
    echo "| 2. Daftar \n";
    echo "| Pilih: ";
...
$random_name = "Fitria"." ".substr(str_shuffle("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 4);
